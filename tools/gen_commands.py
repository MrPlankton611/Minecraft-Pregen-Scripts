...
def final_fix_functions():
    # Delete everything inside the worlds folder
    if os.path.exists(world_funcs_dir):
        shutil.rmtree(world_funcs_dir)
    ...
    for i, seed in enumerate(seeds, starting_world_number):
